 ...
 * LoginPage class holds initial functionality to prompt user to Login to the Gam
 *
 */
public class LoginPage extends DrawingSurface {
	...
	/**
	 * usernameToChange - String variable that holds the user inputted username in the case of a changePassword event
	 */
	...
	/**
	 * passwordToChange - String variable that holds the user inputted password in the case of a changePassword event	
	 */
	private String passwordToChange;
	
	/**
	 * verifyPasswordToChange - String variable that holds the user inputted password to verify it in the case of a changePassword event
	 */
	 ...
	 * @param presentUser - boolean value to check if the username prompt needs to be shown multiple times
	 * depending on presentUser boolean, presents windows for the user to verify their new password upon a changePassword button click
	 * 
	 */
	 ...
	 * @param e - Drawable object
	 * checks for a mouseclick on the DrawingSurface, then determines if the clickable surface was any of the buttons created.
	 * if login button, prompts user to enter username and password
	 * if changePassword button, prompts user to enter their username depending on the boolean presentUser, and create new password and verify it.
	 */
