...
interface GameManagerInterface {
    ...
    * @param p is the player to add to the list of players.
    * @param playerList is the list of players.
    */
    void addPlayer(Player p, ArrayList<Player> playerList);

    /** Adds a value to the pegging total.
    * @param amountToAdd is the amount to add to the pegging total.
    ...
    * @param c is the card to add to the pone's list of pegging cards.
    */
    void addPonePeggingCard(Card c);

    /** Adds a card to the list of the dealer's pegging cards.
    @param c is the card to add to the dealer's list of pegging cards.
    */
