...
//
// /**
// If the player passed as a parameter placed a card during the pegging phase
// that
// brought the pegging total to 31, the player is awarded 2 points. Otherwise,
// the
// player is awarded no points.
// @param p is the player making the claim that he or she placed a card that
// brought
...
//
// /**
// If the player passed as a parameter placed a card that immediately followed a
// card with the
// same numerical value, the player is awarded 2 points. Otherwise, the player
// is awarded no points.
// @param the player who made the claim of having a pair during the pegging
// phase
// */
...
//
// /**
// If the player passed as a parameter placed a card that immediately followed
// two cards with the
// same numerical values, the player is awarded 6 points. Otherwise, the player
// is awarded no points.
// @param the player who made the claim of having a 3 pair during the pegging
// phase
// */
...
//
// /**
// If the player passed as a parameter has a run of 3, the player is awarded 3
// points.
...
//
// /**
// If the player passed as a parameter has a run of 4, the player is awarded 4
// points.
// Otherwise, the player isn't awarded any points.
...
//
// //make sure there are no cards with the same identifiers
// if (firstCardId == secondCardId || firstCardId == thirdCardId || firstCardId
// == fourthCardId){
...
//
// /**
// If the player passed as a parameter has a run of 5, the player is awarded 5
// points.
// Otherwise, the player isn't awarded any points.
...
// //make sure there are no cards with the same identifiers
// if (firstCardId == secondCardId || firstCardId == thirdCardId || firstCardId
// == fourthCardId || firstCardId == fifthCardId ){
// //send information to front end that there isn't a run of 4
// return;
// }
//
...
//
// /**
// If the player passed as a parameter has a run of 6, the player is awarded 6
// points.
// Otherwise, the player isn't awarded any points.
...
// //make sure there are no cards with the same identifiers
// if (firstCardId == secondCardId || firstCardId == thirdCardId || firstCardId
// == fourthCardId || firstCardId == fifthCardId || firstCardId == sixthCardId){
// //send information to front end that there isn't a run of 4
// return;
// }
//
...
// }
//
// if (thirdCardId == fourthCardId || thirdCardId == fifthCardId || thirdCardId
// == sixthCardId ){
// //send information to front end that there isn't a run of 4
// return;
// }
...
//
// /**
// If the player passed as a parameter has a run of 7, the player is awarded 7
// points.
// Otherwise, the player isn't awarded any points.
...
// if (firstCardId == secondCardId || firstCardId == thirdCardId || firstCardId
// == fourthCardId || firstCardId == fifthCardId || firstCardId == sixthCardId
// || firstCardId == seventhCardId){
// //send information to front end that there isn't a run of 4
// return;
// }
//
// if (secondCardId == thirdCardId || secondCardId == fourthCardId ||
// secondCardId == fifthCardId || secondCardId == sixthCardId || secondCardId ==
// seventhCardId ){
// //send information to front end that there isn't a run of 4
// return;
// }
//
// if (thirdCardId == fourthCardId || thirdCardId == fifthCardId || thirdCardId
// == sixthCardId || thirdCardId == seventhCardId){
// //send information to front end that there isn't a run of 4
// return;
// }
//
...
// if (secondInRunNextId == firstCardId || secondInRunNextId == thirdCardId ||
// secondInRunNextId == fourthCardId || secondInRunNextId == fifthCardId ||
// secondInRunNextId == sixthCardId || secondInRunNextId == seventhCardId){
// numEqual++;
// }
//
// if (thirdInRunNextId == firstCardId || thirdInRunNextId == secondCardId ||
...
// if (fourthInRunNextId == firstCardId || fourthInRunNextId == secondCardId ||
// fourthInRunNextId == thirdCardId || fourthInRunNextId == fifthCardId ||
// fourthInRunNextId == sixthCardId || fourthInRunNextId == seventhCardId){
// numEqual++;
// }
//
// if (fifthInRunNextId == firstCardId || fifthInRunNextId == secondCardId ||
...
// }
//
// if (seventhInRunNextId == firstCardId || seventhInRunNextId == secondCardId
// || seventhInRunNextId == thirdCardId || seventhInRunNextId == fourthCardId ||
// seventhInRunNextId == fifthCardId || seventhInRunNextId == sixthCardId){
// numEqual++;
// }
//
//
...
// //so, when player p makes a claim that the last card was placed, player p
// played the most recent card
...
//
//
// //to check a claim for points, we would need a record of which cards had been
// placed
...
// moved from the
// //player's hand
// //it should be removed and placed in another array and placed back into the
// player's hand at the end of the
// //pegging phase
//
...
// //if a player places a card that immediately follows two cards with the same
// numerical values, the player gets 6 points
