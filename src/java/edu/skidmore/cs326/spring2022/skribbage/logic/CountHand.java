...
// p.addPoints(5);
// }
// //if check flush = false && Flusharr.get(i).getIdentifier()==
// Flusharr.get(i+1).getIdentifier()
// //
// }
//
//
// ArrayList<Card> firsttwo = new
// ArrayList<Card>(p.getHand().getHand().subList(0, 1));
...
// }
// //
// // ArrayList<Card> secondtwo = new
// ArrayList<Card>(p.getHand().getHand().subList(1, 2));
...
// // }
// //
// // ArrayList<Card> middletwo = new
// ArrayList<Card>(p.getHand().getHand().subList(2, 3));
...
// // }
// // }
// // ArrayList<Card> lasttwo = new
// ArrayList<Card>(playerHand.getHand().getHand.subList(2, 3));
