...
public class PeggingPlay {
    ...
    public void peggingPhase() {
        ...
        // do the following steps while there is at least one card left in one
        ...
        // 5) if the pone makes a claim for pegging points for that card and
        // that card could be placed,
        // check that claim
        ...
        // 9) if the dealer makes a claim for pegging points for that card and
        // that card could be placed,
        // check that claim

        // if the last card was played and all points were added, the pegging
        // phase is over
        // reset peggingCards and add ponePeggingCards and dealerPeggingCards
        // back to each player's hand

    }

    /**
     * Takes a card and a player and adds the card's point value to the total
     * value during pegging play
     * unless 31 < peggingTotal + the value of the card to add. If the card is
     * played during
     * pegging play, the card is temporarily removed from the player's hand who
     * played it.
     * 
     * @param cardToAdd
     *            is the card whose point value will be added to the total if it
     *            meets the condition
     * @param p
     ...
     * followed a card with the
     * same numerical value, the player is awarded 2 points. Otherwise, the
     * player is awarded no points.
     * 
     * @param the
     *            player who made the claim of having a pair during the pegging
     *            phase
     */
    ...
    /**
     * If the player passed as a parameter placed a card that immediately
     * followed two cards with the
     * same numerical values, the player is awarded 6 points. Otherwise, the
     * player is awarded no points.
     * 
     * @param the
     *            player who made the claim of having a 3 pair during the
     *            pegging phase
     */
    public void check3Pair(Player p) {
        ...
        if (p.isDealer) {
            // if the person making the claim is the dealer, the dealer played a
            // card
    ...
    /**
     * If the player passed as a parameter placed a card that immediately
     * followed 3 cards with the
     * same numerical values, the player is awarded 12 points. Otherwise, the
     * player is awarded no points.
     * 
     * @param the
     *            player who made the claim of having a 3 pair during the
...
//   }
  ...
  //
  //
>>>>>>> f21140bb38889f376387d477d72ff42fcfd37596

    // ============ left off here =====================
    //
    //
    // /**
    // If the player passed as a parameter has a run of 3, the player is awarded
    // 3 points.
    // Otherwise, the player isn't awarded any points.
    // @param p is the player who claims to have a run of 3
    // **/
    ...
    // }
    //
    // if (secondInRunNextId == firstCardId || secondInRunNextId ==
    // thirdCardId){
    // numEqual++;
    // }
    //
    ...
    //
    // /**
    // If the player passed as a parameter has a run of 4, the player is awarded
    // 4 points.
    // Otherwise, the player isn't awarded any points.
    // @param p is the player who claims to have a run of 4
    // **/
    ...
    // //check the first next identifier
    // if (firstInRunNextId == secondCardId || firstInRunNextId == thirdCardId
    // || firstInRunNextId == fourthCardId){
    // numEqual++;
    // }
    //
    // if (secondInRunNextId == firstCardId || secondInRunNextId == thirdCardId
    // || secondInRunNextId == fourthCardId){
    // numEqual++;
    // }
    //
    // if (thirdInRunNextId == firstCardId || thirdInRunNextId == secondCardId
    // || thirdInRunNextId == fourthCardId){
    // numEqual++;
    // }
    //
    // if (fourthInRunNextId == firstCardId || fourthInRunNextId == secondCardId
    // || fourthInRunNextId == thirdCardId){
    // numEqual++;
    // }
    //
    // if (numEqual == 3){
    ...
    //
    // /**
    // If the player passed as a parameter has a run of 5, the player is awarded
    // 5 points.
    // Otherwise, the player isn't awarded any points.
    // @param p is the player who claims to have a run of 5
    // **/
    ...
    // //make sure there are no cards with the same identifiers
    // if (firstCardId == secondCardId || firstCardId == thirdCardId ||
    // firstCardId == fourthCardId || firstCardId == fifthCardId ){
    // //send information to front end that there isn't a run of 4
    // return;
    // }
    //
    // if (secondCardId == thirdCardId || secondCardId == fourthCardId ||
    // secondCardId == fifthCardId){
    // //send information to front end that there isn't a run of 4
    // return;
    // }
    //
    ...
    // //check the first next identifier
    // if (firstInRunNextId == secondCardId || firstInRunNextId == thirdCardId
    // || firstInRunNextId == fourthCardId || firstInRunNextId == fifthCardId){
    // numEqual++;
    // }
    //
    // if (secondInRunNextId == firstCardId || secondInRunNextId == thirdCardId
    // || secondInRunNextId == fourthCardId || secondInRunNextId ==
    // fifthCardId){
    // numEqual++;
    // }
    //
    // if (thirdInRunNextId == firstCardId || thirdInRunNextId == secondCardId
    // || thirdInRunNextId == fourthCardId || thirdInRunNextId == fifthCardId){
    // numEqual++;
    // }
    //
    // if (fourthInRunNextId == firstCardId || fourthInRunNextId == secondCardId
    // || fourthInRunNextId == thirdCardId || fourthInRunNextId == fifthCardId){
    // numEqual++;
    // }
    //
    // if (fifthInRunNextId == firstCardId || fifthInRunNextId == secondCardId
    // || fifthInRunNextId == thirdCardId || fifthInRunNextId == fourthCardId){
    // numEqual++;
    // }
    //
    //
    ...
    //
    // /**
    // If the player passed as a parameter has a run of 6, the player is awarded
    // 6 points.
    // Otherwise, the player isn't awarded any points.
    // @param p is the player who claims to have a run of 6
    // **/
    ...
    // //make sure there are no cards with the same identifiers
    // if (firstCardId == secondCardId || firstCardId == thirdCardId ||
    // firstCardId == fourthCardId || firstCardId == fifthCardId || firstCardId
    // == sixthCardId){
    // //send information to front end that there isn't a run of 4
    // return;
    // }
    //
    // if (secondCardId == thirdCardId || secondCardId == fourthCardId ||
    // secondCardId == fifthCardId || secondCardId == sixthCardId){
    // //send information to front end that there isn't a run of 4
    // return;
    // }
    //
    // if (thirdCardId == fourthCardId || thirdCardId == fifthCardId ||
    // thirdCardId == sixthCardId ){
    // //send information to front end that there isn't a run of 4
    // return;
    // }
    //
    ...
    // if (firstInRunNextId == secondCardId || firstInRunNextId == thirdCardId
    // || firstInRunNextId == fourthCardId || firstInRunNextId == fifthCardId ||
    // firstInRunNextId == sixthCardId){
    // numEqual++;
    // }
    //
    // if (secondInRunNextId == firstCardId || secondInRunNextId == thirdCardId
    // || secondInRunNextId == fourthCardId || secondInRunNextId == fifthCardId
    // || secondInRunNextId == sixthCardId){
    // numEqual++;
    // }
    //
    // if (thirdInRunNextId == firstCardId || thirdInRunNextId == secondCardId
    // || thirdInRunNextId == fourthCardId || thirdInRunNextId == fifthCardId ||
    // thirdInRunNextId == sixthCardId ){
    // numEqual++;
    // }
    //
    // if (fourthInRunNextId == firstCardId || fourthInRunNextId == secondCardId
    // || fourthInRunNextId == thirdCardId || fourthInRunNextId == fifthCardId
    // || fourthInRunNextId == sixthCardId){
    // numEqual++;
    // }
    //
    // if (fifthInRunNextId == firstCardId || fifthInRunNextId == secondCardId
    // || fifthInRunNextId == thirdCardId || fifthInRunNextId == fourthCardId ||
    // fifthInRunNextId == sixthCardId){
    // numEqual++;
    // }
    //
    // if (sixthInRunNextId == firstCardId || sixthInRunNextId == secondCardId
    // || sixthInRunNextId == thirdCardId || sixthInRunNextId == fourthCardId ||
    // sixthInRunNextId == fifthCardId){
    // numEqual++;
    // }
    //
    //
    ...
    //
    // /**
    // If the player passed as a parameter has a run of 7, the player is awarded
    // 7 points.
    // Otherwise, the player isn't awarded any points.
    // @param p is the player who claims to have a run of 7
    // **/
    ...
    // if (firstCardId == secondCardId || firstCardId == thirdCardId ||
    // firstCardId == fourthCardId || firstCardId == fifthCardId || firstCardId
    // == sixthCardId || firstCardId == seventhCardId){
    // //send information to front end that there isn't a run of 4
    // return;
    // }
    //
    // if (secondCardId == thirdCardId || secondCardId == fourthCardId ||
    // secondCardId == fifthCardId || secondCardId == sixthCardId ||
    // secondCardId == seventhCardId ){
    // //send information to front end that there isn't a run of 4
    // return;
    // }
    //
    // if (thirdCardId == fourthCardId || thirdCardId == fifthCardId ||
    // thirdCardId == sixthCardId || thirdCardId == seventhCardId){
    // //send information to front end that there isn't a run of 4
    // return;
    // }
    //
    // if (fourthCardId == fifthCardId || fourthCardId == sixthCardId ||
    // fourthCardId == seventhCardId){
    // //send information to front end that there isn't a run of 4
    // return;
    // }
    //
    ...
    // if (firstInRunNextId == secondCardId || firstInRunNextId == thirdCardId
    // || firstInRunNextId == fourthCardId || firstInRunNextId == fifthCardId ||
    // firstInRunNextId == sixthCardId || firstInRunNextId == seventhCardId){
    // numEqual++;
    // }
    //
    // if (secondInRunNextId == firstCardId || secondInRunNextId == thirdCardId
    // || secondInRunNextId == fourthCardId || secondInRunNextId == fifthCardId
    // || secondInRunNextId == sixthCardId || secondInRunNextId ==
    // seventhCardId){
    // numEqual++;
    // }
    //
    // if (thirdInRunNextId == firstCardId || thirdInRunNextId == secondCardId
    // || thirdInRunNextId == fourthCardId || thirdInRunNextId == fifthCardId ||
    // thirdInRunNextId == sixthCardId || thirdInRunNextId == seventhCardId ){
    // numEqual++;
    // }
    //
    // if (fourthInRunNextId == firstCardId || fourthInRunNextId == secondCardId
    // || fourthInRunNextId == thirdCardId || fourthInRunNextId == fifthCardId
    // || fourthInRunNextId == sixthCardId || fourthInRunNextId ==
    // seventhCardId){
    // numEqual++;
    // }
    //
    // if (fifthInRunNextId == firstCardId || fifthInRunNextId == secondCardId
    // || fifthInRunNextId == thirdCardId || fifthInRunNextId == fourthCardId ||
    // fifthInRunNextId == sixthCardId || fifthInRunNextId == seventhCardId){
    // numEqual++;
    // }
    //
    // if (sixthInRunNextId == firstCardId || sixthInRunNextId == secondCardId
    // || sixthInRunNextId == thirdCardId || sixthInRunNextId == fourthCardId ||
    // sixthInRunNextId == fifthCardId || sixthInRunNextId == seventhCardId){
    // numEqual++;
    // }
    //
    // if (seventhInRunNextId == firstCardId || seventhInRunNextId ==
    // secondCardId || seventhInRunNextId == thirdCardId || seventhInRunNextId
    // == fourthCardId || seventhInRunNextId == fifthCardId ||
    // seventhInRunNextId == sixthCardId){
    // numEqual++;
    // }
    //
    //
    ...
    //
    // //Question about lastCard:
    // //is the last card the card played last in a sequence during pegging play
    // or is the last card
    // //the last card to be played out of both player's hands
    //
    // /**
    // If the player passed as a parameter placed the final card during pegging
    // play,
    // the player receives 1 point. Otherwise, the player receives no points for
    // this claim.
    // @param p is the player who is claiming to have placed the last card
    // */
    // // private void lastCard(Player p){
    ...
    // // //the last card in peggingCards was placed by p
    // // //how do we know whether p placed the final card?
    // // //I think we can know this implicitly because points are earned as
    // played
    // // //and claims are made as played
    // // //so, when player p makes a claim that the last card was placed,
    // player p played the most recent card
    // // //if there are no more cards to be placed, the p placed the last card
    // //
    // // if (Game.getPlayerList().size() == 2){
    // // if (peggingCards.size() == 8){
    ...
    // //
    // // public void go(){
    // // //if a player cannot play a card without exceeding 31, the player says
    // go
    // // //this method is called
    // // //if the other player can play a card without exceeding 31
    // // //the other player gets 1 point
    // // //if the other player plays the last card, the other player gets
    // another point
    // // //if the other player cannot play a card without exceeding 31
    // // //the first player who said go gets 1 point
    // //
    ...
    //
    //
    // //to check a claim for points, we would need a record of which cards had
    // been placed
    // //we can keep this record with an ArrayList in the class
    //
    // //when a player places a card down successfully, it should be temporarily
    // moved from the
    // //player's hand
    // //it should be removed and placed in another array and placed back into
    // the player's hand at the end of the
    // //pegging phase
    //
    // //ways to score in pegging play
    // //if a player places a card that brings the total to 15 or 31, then the
    // player gets 2 points
    // //if a player places a card that immediately follows a card with the same
    // numerical value, the player gets 2 points
    // //if a player places a card that immediately follows two cards with the
    // same numerical values, the player gets 6 points
    // //if a player places a card that immediately follows three cards with the
    // same numerical values, the player gets 12 points
    // //if a player has a run of 3, then the player gets 3 points
    // //if a player has a run of 4, then the player gets 4 points
    // //if a player has a run of 5,6, or 7, then the player gets 5, 6, or 7
    // respectively
    // //if a player creates a go, then they get 1 point
    // //if a player has the last card, they get 1 point
    //
