...
public class DealPhase {
  ...
  /**
   * Constructor for DealPhase to pass in the current game for DealPhase to use.
   *
   * @param g
  ...
  public void dealPhase() {
    ...
    if (amountToCutP2 < 4 || amountToCutP2 > 22) {
      ...
      // for now, print to console
      System.out.println(
          "The amount of cards to cut must be atleast 4 and less than 22 for the second cut.");
    }
