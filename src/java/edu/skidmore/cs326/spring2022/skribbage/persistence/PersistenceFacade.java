...
public final class PersistenceFacade implements UserManagement, GameManagement, InventoryManagement {
	 ...
	 * @return boolean Returns true or false depending on whether the method worked
	 */
	@Override
	...
	/**
	 * This will take in a current user, current password and the new password in
	 * order to change passwords.
	 * 
	 * @param userToUpdate    This is the user that want to change their password
	 * @param currentPassword This is the current password that they have in their
	 *                        account
	...
	/**
	 * This will take in a user and the arg of what needs to be change and change
	 * it.
	 * 
