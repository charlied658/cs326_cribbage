 ...
 */
public class PlayerPlayCardEventTest {
    /**
     * Test Instance for LobbyEvent testing.
     */
    private PlayerPlayCardEvent testInstance;
    /**
     * User test instance.
     */
    ...
    static {
        LOG = Logger.getLogger(PlayerPlayCardEventTest.class);
    }
    ...
    public void setUp() {
        ...
        testInstance = new PlayerPlayCardEvent(this, player, cardImage, 5);
    ...
    public void testGetEventType() {
        ...
        assertEquals(testInstance.getEventType(), EventType.PLAYER_PLAY_CARD);
