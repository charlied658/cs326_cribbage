...
public class PeggingTest {
    ...
    //
    // //cases
    // //the player is a dealer and placed a card that brought the pegging total
    // to 15
    // //the player is a pone and placed a card that brought the pegging total
    // to 15
    ...
    // identifier
    // //the method returns false if the cards in the list don't have the same
    // identifier
